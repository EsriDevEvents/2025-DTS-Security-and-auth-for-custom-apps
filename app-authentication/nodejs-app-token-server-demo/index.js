...
var privateKey = fs.readFileSync("/Users/mark4582/ssl/local3.key", "utf8")
var certificate = fs.readFileSync("/Users/mark4582/ssl/local3.crt", "utf8")
...
var clientSession = ClientSession({
  ...
  store: new FileStore({
    ...
    decoder: (sessionContents) => {
      ...
      if (typeof session.userSession === "string") {
        session.userSession = UserSession.deserialize(session.userSession)
      }
      return session
    },
  }),
